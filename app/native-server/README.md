...
This is a Fastify-based TypeScript project for native communication with Chrome extensions.
...
1. Locally build and register native server
...
// Connect Native host on extension startup
